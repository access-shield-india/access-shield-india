...
| **[deployment/](../deployment/README.md) — AccessibleNow self-host (canonical)** | machine1/machine3 topology, scripts map, Compose, host-tools, day-2 |
...
**Suggested reading order:** 01 → 02 → 03 → 04, then 05–08 as needed for your role. Read 09 before any Supabase cutover work. For **self-hosted AccessibleNow**, use [deployment/](../deployment/README.md). For the **web-scan worker split (v2)**, read [v2/](./v2/README.md) after 05 — default deploy remains v1 until flags are enabled.
