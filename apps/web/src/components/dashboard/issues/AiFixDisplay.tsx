...
/** Shown when the fix was generated by the local dev mock, not the AI service. */
      ...
      <div className="flex gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm leading-normal text-warning-700">
            This fix was generated by the API mock because the AI service was unreachable. Check that{' '}
            ...
            running (Anthropic key or local LLM per Settings → AI Configuration). Then click
            Regenerate AI fix.
          </p>
        </div>
      </div>
