...
export function AboutIllustration(props: IllustrationProps) {
  return (
    <IllustrationFrame {...props}>
      ...
      <circle cx="400" cy="72" r="48" fill="#F3E8FF" />
      <circle cx="88" cy="300" r="36" fill="#F3E8FF" />
      <rect
        x="120"
        y="88"
        width="240"
        ...
        strokeWidth="2"
      />
      <rect x="144" y="112" width="80" height="12" rx="6" fill="#6D28D9" opacity="0.2" />
      ...
      <circle cx="176" cy="228" r="20" fill="#6D28D9" opacity="0.15" />
      <path d="M168 228h16M176 220v16" stroke="#6D28D9" strokeWidth="2.5" strokeLinecap="round" />
      ...
      />
      <circle cx="72" cy="140" r="28" fill="#6D28D9" />
      ...
      <circle cx="408" cy="200" r="28" fill="#8B5CF6" />
  ...
  return (
    <IllustrationFrame {...props}>
      ...
      <rect
        ...
        strokeWidth="2"
      />
      <circle cx="240" cy="120" r="36" fill="#F3E8FF" />
      <path
        d="M224 120c0-8.837 7.163-16 16-16s16 7.163 16 16v4h-32v-4z"
        fill="#6D28D9"
        opacity="0.3"
      />
      <rect x="216" y="124" width="48" height="32" rx="16" fill="#6D28D9" />
      <path d="M228 148h24" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" />
      <rect x="168" y="188" width="144" height="12" rx="6" fill="#F3E8FF" />
      <rect x="168" y="212" width="120" height="12" rx="6" fill="#F3E8FF" />
      <rect x="168" y="236" width="96" height="12" rx="6" fill="#6D28D9" opacity="0.25" />
      <rect
        x="60"
        y="140"
        width="64"
  ...
  return (
    <IllustrationFrame {...props}>
      ...
      <path
        ...
        fill="none"
      />
      <circle cx="180" cy="180" r="8" fill="#6D28D9" />
      <circle cx="240" cy="200" r="8" fill="#8B5CF6" />
      ...
      <rect x="340" y="48" width="80" height="32" rx="16" fill="#6D28D9" />
  ...
  return (
    <IllustrationFrame {...props}>
      ...
      <rect
        ...
        strokeWidth="2"
      />
      <rect x="180" y="72" width="120" height="10" rx="5" fill="#6D28D9" opacity="0.3" />
...
export function ServicesIllustration(props: IllustrationProps) {
  return (
    <IllustrationFrame {...props}>
      ...
      <circle cx="256" cy="248" r="40" fill="#FFFFFF" stroke="#6D28D9" strokeWidth="3" />
      <circle cx="256" cy="248" r="24" stroke="#6D28D9" strokeWidth="3" fill="none" />
      <path d="M272 264 L296 288" stroke="#6D28D9" strokeWidth="4" strokeLinecap="round" />
    </IllustrationFrame>
  );
}
  ...
  return (
    <IllustrationFrame {...props}>
      ...
      <rect
        ...
        strokeWidth="2"
      />
      <rect x="160" y="88" width="80" height="8" rx="4" fill="#6D28D9" opacity="0.4" />
      ...
      <rect
        ...
        strokeWidth="2"
      />
      <rect x="240" y="124" width="80" height="10" rx="5" fill="#6D28D9" opacity="0.3" />
      <rect x="240" y="148" width="72" height="6" rx="3" fill="#D1D5DB" />
      <rect x="240" y="164" width="80" height="6" rx="3" fill="#D1D5DB" />
      <circle cx="280" cy="220" r="32" fill="#F3E8FF" stroke="#6D28D9" strokeWidth="2" />
      <path d="M264 220h32M280 204v32" stroke="#6D28D9" strokeWidth="2.5" strokeLinecap="round" />
    </IllustrationFrame>
  );
}
  ...
  return (
    <IllustrationFrame {...props}>
      ...
      <rect
        ...
        strokeWidth="2"
      />
      <path d="M148 140h24M160 128v24" stroke="#6D28D9" strokeWidth="2.5" strokeLinecap="round" />
      <rect x="212" y="112" width="140" height="10" rx="5" fill="#6D28D9" opacity="0.25" />
  ...
  return (
    <IllustrationFrame {...props}>
      ...
      <rect
        ...
        strokeWidth="2"
      />
      <rect x="216" y="160" width="48" height="40" rx="4" fill="#6D28D9" opacity="0.2" />
      <circle cx="240" cy="132" r="16" fill="#6D28D9" />
